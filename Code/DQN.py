...
class DQN:
    def __init__(self, params, quantiles):
        self.params = params
        ...
        self.optim = tf.train.AdamOptimizer(self.params['lr']).minimize(self.combined_loss)
        # self.optim = tf.train.AdamOptimizer(self.params['lr']).minimize(self.combined_loss, global_step=self.global_step)
